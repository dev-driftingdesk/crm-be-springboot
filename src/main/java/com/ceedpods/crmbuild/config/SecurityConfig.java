...
public class SecurityConfig {
    ...
    // Swagger security filter chain with Basic Auth (higher priority)
    @Bean
    @Order(1)
    ...
    // Main API security filter chain with JWT (lower priority)
    @Bean
    @Order(2)
    ...
    // In-memory user for Swagger Basic Auth
    @Bean
